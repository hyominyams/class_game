...
export const ArcGalleryHero: React.FC<ArcGalleryHeroProps> = ({
    ...
    if (!mounted) return <section className={`bg-white dark:bg-gray-900 min-h-screen ${className}`} />;
    ...
    return (
        <section className={`relative overflow-hidden bg-white dark:bg-gray-900 text-gray-900 dark:text-white min-h-screen flex flex-col ${className}`}>
            ...
            <div className="relative z-10 flex-1 flex items-center justify-center px-6 -mt-32 md:-mt-48 lg:-mt-64 pb-20">
                <div className="text-center max-w-4xl px-6 opacity-0 animate-fade-in" style={{ animationDelay: '800ms', animationFillMode: 'forwards' }}>
                    <div className="text-4xl sm:text-6xl lg:text-7xl font-black tracking-tighter text-gray-900 dark:text-white leading-[1.1] whitespace-pre-line">
                        {title || "Rediscover Your Memories with AI"}
                    </div>
                    <p className="mt-6 text-lg md:text-xl text-gray-600 dark:text-gray-300 font-medium max-w-2xl mx-auto">
