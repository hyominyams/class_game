    ...
    "inline-flex h-12 items-center justify-center whitespace-nowrap px-6 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
    {
        variants: {
            variant: {
                ...
                active: "bg-[#08d9d6] text-black border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] translate-y-[-2px] rubik-font font-bold",
            },
        },
        defaultVariants: {
            variant: "default",
...
interface TeacherPixelTabsProps {
    className?: string;
    routes: TabRoute[];
}

export function TeacherPixelTabs({ className, routes }: TeacherPixelTabsProps) {
